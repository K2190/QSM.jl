function ilsqr(f, mask, vsz, bdir, tol, maxit, verbose)
...
#       quantitative susceptibility mapping. Neuroimage. 2015 Mar 1;108:111-22.
    ...
    return [x, xsa, xfs, xlsqr]
end


function ilsqr_(f, m, D, vsz, tol, maxit, verbose)
...
function susceptibilityArtifacts_(x0, xfs, mask, vsz, D, tol, maxit, verbose)
