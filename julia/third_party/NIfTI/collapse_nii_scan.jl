...
function collapse_nii_scan(scan_pattern, fileprefix, scan_path)
   ...
   if length(filename) > 2 & strcmp(filename(end-2:end), ".gz")
	 ...
	 ~strcmp(filename(end-6:end), ".nii.gz")
      ...
      if ~strcmp(filename(end-3:end), ".img") && ~strcmp(filename(end-3:end), ".hdr")
   ...
   case   1,
      hdr.dime.bitpix = convert_to_int16(1 ) 
      precision = "ubit1"

   case   2,
      hdr.dime.bitpix = convert_to_int16(8 )
      precision = "uint8"
   case   4,
      hdr.dime.bitpix = convert_to_int16(16)
      precision = "int16"
   case   8,
      hdr.dime.bitpix = convert_to_int16(32) 
      precision = "int32"
   case  16,
      hdr.dime.bitpix = convert_to_int16(32) 
      precision = "float32"
   case  32,
      hdr.dime.bitpix = convert_to_int16(64) 
      precision = "float32"
   case  64,
      hdr.dime.bitpix = convert_to_int16(64) 
      precision = "float64"
   case 128,
      hdr.dime.bitpix = convert_to_int16(24) 
      precision = "uint8"
   case 256 
      hdr.dime.bitpix = convert_to_int16(8 )
      precision = "int8"
   ...
   case 1280
      ...
      precision = "uint64"
   case 1792,
      hdr.dime.bitpix = convert_to_int16(128) 
      precision = "float64"
   otherwise
