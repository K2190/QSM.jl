...
#
function load_nii_ext(filename)
   ...
   if findstr(".nii",filename) && filename[end-3:end] == ".nii"
      new_ext = 1
      filename[end-3:end] = ""
   end

   if findstr(".hdr",filename) && filename[end-3:end] == ".hdr"
      filename[end-3:end]=""
   end

   if findstr(".img",filename) && filename[end-3:end] == ".img"
      filename[end-3:end]=""
   end
